...
const MIN_HEIGHT_PT = 6;

// Handles sit fully outside the bbox — see ResizeHandles.tsx for rationale.
...
export function InsertionResizeHandles({ insertionId, bbox, cssScale, page }: Props) {
  ...
  const onPointerMove = useCallback(
    (e: React.PointerEvent<HTMLDivElement>) => {
      ...
      updateInsertion(insertionId, { bbox: clamped });
    },
    [cssScale, page, insertionId, updateInsertion],
  );
